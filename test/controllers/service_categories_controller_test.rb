...
class ServiceCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create service_category" do
    assert_difference('ServiceCategory.count') do
      post :create, service_category: { description: @service_category.description, name: @service_category.name, url_name: @service_category.url_name }
    end
  ...
  test "should update service_category" do
    patch :update, id: @service_category, service_category: { description: @service_category.description, name: @service_category.name, url_name: @service_category.url_name }
    assert_redirected_to service_category_path(assigns(:service_category))
  end
